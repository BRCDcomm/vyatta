...
class VyattaVRouterPlugin(common_db_mixin.CommonDbMixin,
    ...
    def create_router(self, context, router):
        ...
        except (vrouter_driver.InvalidVRouterInstance,
                vrouter_driver.InvalidInstanceConfiguration,
                vrouter_driver.VRouterConnectFailure,
                vrouter_driver.VRouterOperationError,
                Exception):
    ...
    def update_router(self, context, router_id, router):
        ...
        return super(VyattaVRouterPlugin, self).update_router(
    ...
    def _attach_port(self, context, router_id, port, external_gw=False):
        ...
        vrouter_driver.retry(
            configure_gateway_wrapper,
            exceptions=(vrouter_driver.VRouterOperationError,),
    ...
    def _update_router_gw_info(self, context, router_id, info, router=None):
        ...
        if network_id is not None and (gw_port is None or
            ...
            self._validate_gw_info(context, gw_port, info)
            subnets = (
                self._core_plugin._get_subnets_by_network(
            ...
            gw_port = self._core_plugin.create_port(context.elevated(), {
                'port': {'tenant_id': cfg.CONF.VROUTER.tenant_id,
    ...
    def _update_extra_routes(self, context, router, routes):
        ...
        routes_old = self._get_extra_routes_by_router_id(
            context, router['id'])
        super(VyattaVRouterPlugin, self)._update_extra_routes(
    ...
    def _route_rules_to_set(rules):
        result = set()
        for r in rules:
            result.add(vrouter_driver.RouteRule(
    ...
    def disassociate_floatingips(self, context, port_id, do_notify=True):
        ...
        return super(VyattaVRouterPlugin, self).disassociate_floatingips(
